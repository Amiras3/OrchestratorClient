...
namespace WebClient.Models
{
    ...
    public partial class QueueDefinitionDto
    {
        ...
        /// the queue.</param>
        public QueueDefinitionDto(string name, string description = default(string), int? maxNumberOfRetries = default(int?), bool? acceptAutomaticallyRetry = default(bool?), bool? enforceUniqueReference = default(bool?), System.DateTime? creationTime = default(System.DateTime?), long? releaseId = default(long?), long? processScheduleId = default(long?), string releaseName = default(string), long? id = default(long?))
        {
            Name = name;
        ...
        /// <summary>
        /// Gets or sets the Id of the process associated with the queue.
        /// </summary>
